function AutoDrive:loadGUI()
	...
	--AutoDrive.gui.ADBoomSelectGui = ADBoomSelectGui:new()
	...
	--g_gui:loadGui(AutoDrive.directory .. "gui/boomSelectGUI.xml", "ADBoomSelectGui", AutoDrive.gui.ADBoomSelectGui)
